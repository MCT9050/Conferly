      ...
      <section id="business" className="px-5 sm:px-8 py-20 sm:py-28">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">Elevate your team's<br /><span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">collaboration.</span></h2>
            <p className="text-slate-400">Purpose-built for organizations that value security, inclusivity, and focused connection.</p>
          </div>
          ...
          <div className="rounded-3xl border border-white/5 bg-gradient-to-b from-blue-600/[0.06] to-transparent p-10 sm:p-16 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight leading-tight">
                Elevate your team's
                <br />
                <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">collaboration.</span>
              </h2>

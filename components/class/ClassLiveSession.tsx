// components/class/ClassLiveSession.tsx
// Self-contained classroom-specific live session component.
  ...
  return (
    <div className="p-4 space-y-3">
      <div className="rounded-xl border border-slate-700/40 bg-slate-800/40 p-4 space-y-2">
        <h3 className="font-semibold text-slate-200 text-sm">Classroom security</h3>
        <p className="text-xs text-slate-400 leading-relaxed">
          Classrooms can be set to open enrollment, invite-only, or paid access.
        </p>
      </div>
    </div>
  );
...
function PulsePanel() {
  return (
    <div className="p-6 text-sm text-slate-400 space-y-3">
      <p className="font-semibold text-slate-200">AI Lesson Pulse</p>
      <p>
        Once a transcript is available, Conferly will surface key topics and
        learning moments with citations.
      </p>
    </div>
  );
}

        ...
        <nav className="flex-1 px-3 space-y-1">
          {[
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all ${sidebarTab === item.id
              ...
              <div className="glass rounded-2xl p-6 space-y-6">
                ...
                <div className="border-t border-slate-700/30 pt-6">
                  ...
                  <div className="space-y-3">
                    {[
                      { label: 'Enable microphone by default', enabled: true },
                      { label: 'Enable camera by default', enabled: false },
                      { label: 'Show transcription in meetings', enabled: planLimits.transcription },
                      { label: 'Record meetings automatically', enabled: planLimits.recording },
                    ].map(setting => (
                      <div key={setting.label} className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          disabled={!setting.enabled && !planLimits.recording}
                        >
              ...
              <div className="glass rounded-2xl p-6">
                {meetingHistory.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-slate-500 text-sm">Your meeting history will appear here once you start or join meetings.</p>
                    <button
                  ...
                  <div className="space-y-4">
                    {meetingHistory.slice(0, 10).map(meeting => (
                      <div key={meeting.id} className="flex items-center justify-between p-4 rounded-lg bg-slate-800/40 hover:bg-slate-700/40 transition-colors">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-slate-500">
                              {new Date(meeting.startedAt).toLocaleDateString()} • {formatDuration(meeting.durationSeconds)}
                            </div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <button className="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-600 transition-colors">
                            <ArrowRight className="w-4 h-4" />
                          </button>
                        </div>
                      </div>
